...
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
I worry about the fact that Code.lua could be outdated, also, the notepad script textbox needs a name so i can detect it and not make it rounded
...
return function(data)
	...
	function create(class, dataFound, existing)
		...
		if class == "Boolean" then
			...
			new.Text = (enabled and "[ON]") or "[OFF]"
			new.MouseButton1Down:Connect(function()
				if onToggle then
					toggle()
				end
